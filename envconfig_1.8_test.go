...
func TestParseURL(t *testing.T) {
	...
	os.Clearenv()
	os.Setenv("ENV_CONFIG_URLVALUE", "https://github.com/cmmoran/envconfig")
	os.Setenv("ENV_CONFIG_URLPOINTER", "https://github.com/cmmoran/envconfig")
	...
	u, err := url.Parse("https://github.com/cmmoran/envconfig")
	if err != nil {
